...
public final class Constants {
    ...
    public static final String YOUNG_ADULT = "youngAdult";
    public static final Integer BABY_UPPER = 5;
    public static final Integer KID_LOWER = 5;
    public static final Integer KID_UPPER = 12;
